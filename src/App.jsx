        ...
        <div style={{ padding:"1.5rem" }}>
          ...
          <div style={{ borderTop:"1px solid "+T.border, paddingTop:"1.25rem" }}>
            ...
            {place.googleReviews && place.googleReviews.length > 0 && (<>
              ...
              <a href={"https://www.google.com/maps/place/?q=place_id:"+place.placeId} target="_blank" rel="noreferrer"
                style={{ display:"inline-flex", alignItems:"center", gap:"0.4rem", color:"#4285F4", fontSize:"0.75rem", fontWeight:600, textDecoration:"none", marginTop:"0.5rem" }}>
